...
/**
 * @author Sandro Peixoto <contato@sandropeixoto.com.br>
 * @copyright Nano Network 2018
 * @package coluna_vh
 * 
 * 
...
$config["dbase"] 		= "db_coluna_vh" ; 		//Database
$config["utf8"] 		= true ; 		//turkish charset set false
$config["timezone"] 		= "Asia/Jakarta" ; 		//turkish charset set false
$config["abs_url_images"] 		= "http://domain.com/apps/coluna_vh//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://domain.com/apps/coluna_vh//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://domain.com/apps/coluna_vh//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://domain.com/apps/coluna_vh//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	// TODO: -+- route
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "Coluna VH" ;
		$rest_api["site"]["description"] = "Coluna VH" ;
		$rest_api["site"]["imabuilder"] = "rev18.06.04" ;
